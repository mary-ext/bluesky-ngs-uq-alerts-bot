/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b3a41ea3f789e209939f986b9224f369)
...
declare namespace Cloudflare {
	...
	interface Env {
		KV: KVNamespace;
		BLUESKY_JP_PDS: string;
		BLUESKY_JP_IDENTIFIER: string;
		BLUESKY_JP_PASSWORD: string;
		BLUESKY_GL_PDS: string;
		BLUESKY_GL_IDENTIFIER: string;
		BLUESKY_GL_PASSWORD: string;
	}
}
